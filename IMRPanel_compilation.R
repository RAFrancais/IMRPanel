...
Lstate <- list(cov2011 = cov2011, cov2012 = cov2012, cov2013 = cov2013, cov2014 = cov2014, hce2011 = hce2011, hce2012 = hce2012, hce2013 = hce2013, hce2014 = hce2014, hhi2011 = hhi2011, hhi2012 = hhi2012, hhi2013 = hhi2013, hhi2014 = hhi2014, imr2011 = imr2011, imr2012 = imr2012, imr2013 = imr2013, imr2014 = imr2014, pop2011 = pop2011, pop2012 = pop2012, pop2013 = pop2013, pop2014 = pop2014)
...
#2011
cbind2011 <- cbind(cov2011, hce2011[2], hhi2011[2], imr2011[2], obe2011[2], pop2011[2:6], smo2011[3])
cbind2011$Year <- "2011"
cbind2011$ID <- c(1:51)
#2012
cbind2012 <- cbind(cov2012, hce2012[2], hhi2012[2], imr2012[2], obe2012[2], pop2012[2:6], smo2012[3])
cbind2012$Year <- "2012"
cbind2012$ID <- c(1:51)
#2013
cbind2013 <- cbind(cov2013, hce2013[2], hhi2013[2], imr2013[2], obe2013[2], pop2013[2:6], smo2013[3])
cbind2013$Year <- "2013"
cbind2013$ID <- c(1:51)
#2014
cbind2014 <- cbind(cov2014, hce2014[2], hhi2014[2], imr2014[2], obe2014[2], pop2014[2:6], smo2014[3])
cbind2014$Year <- "2014"
cbind2014$ID <- c(1:51)
